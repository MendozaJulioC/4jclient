        ...
        try {  
            ...
            for (let index = 0; index < response.data.data.length; index++) {
                options.push({
                    ...
                    value: response.data.data[index].codcomuna
                })
            }
        } catch (error) {
            console.error(error);
      ...
      <form className="mt-4 shadow-lg P-4" onSubmit={handleSubmit}>
        <div className="row p-4">
          ...
          <div className="col-sm-12 col-md-8">
            <label for="inputNombre" className={styles.label1} required > Nombre Coordinador</label>
            <input
              type="text"
              className="form-control form-control-sm"
              id="inputNombre"
          ...
          <div className="col-md-12">
            ...
            <div className='row'>
              <div className="col-sm-12 mt-2">
                <label for="exampleDataList" className={styles.label1}>Comunas/Corregimientos</label>
                <Select
                  name='selectComunas'
                  ...
                  options={options}
                  placeholder={'Seleccione las comunas/corregimientos'}
                  isMulti
                  isClearable
                />
              </div>
        ...
        <div className="d-grid gap-2 col-6 mx-auto p-4">
          <button className="btn " type="submit" style={{ background: '#116D6E', color: 'white' }} >
