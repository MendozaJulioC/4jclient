...
const MyBarrios = ()=>{
     ...
     async function getData() {
        try {  
            const response = await axios.get('http//localhost3000/api/datos/territorio/barrios') 
...
const handleonBlur = async (e)=>{
    ...
    if(response.data.length > 0){
      ...
      inputNombre.current= nombre
      const MySwal = withReactContent(Swal)
      MySwal.fire({
        title: <strong>Alerta!</strong>,
        html: <i>El Líder que deseas ingresar ya está en nuestra base de datos!!</i>,
        icon: 'info',
        iconColor: '#4F709C',
        confirmButtonColor: '#4F709C',
        allowOutsideClick: false,
        footer: '<a href="">Intentarlo nuevamente</a>'
      }).then((result) => {
        /* Read more about isConfirmed, isDenied below */
        if (result.isConfirmed) {
          MySwal.fire({
            allowOutsideClick: false,
            html: '<a href="">Intentarlo nuevamente</a>',
  ...
  const handleSubmit = async (e) => {
    ...
    if (selectedOption === null) {
      ...
      errorform.push('Debes seleccionar el Barrio') 
      MySwal2.fire({
        html: <i>Ingresa el barrio!!</i>,
        icon: 'error',
        iconColor: '#DB005B',
    ...
    <div className="container">
      <form className="mt-4 shadow-lg P-4" onSubmit={handleSubmit}>
        <div className="row p-4">
          ...
          <div className="col-md-6">
            <label for='selectRol' className={styles.label1} required>Rol</label>
            <select
        ...
        <div className="row p-4">
          <div className="col-sm-8">
            <label for="inputOrg" className={styles.label1}>Anexar Organización</label>
          ...
          <div className="col-md-4">
            ...
            //  onChange={handleChange}
              ...
              <option value={6}>Medio de Comunicación</option>
