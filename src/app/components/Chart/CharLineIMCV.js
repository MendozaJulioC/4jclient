...
function ChartLineIMCV() {
 ...
 const [ciudad , setCiudad]= useState()
  ...
  async function getIMCV(){
    const respuesta =  await axios.get('/api/datos/imcv');
    let cate= []
    let urban =[]
    let rura = []
    let ciu= []
  ...
  const dataSource = {
       chart: {
        caption: "Índice Multidimensional de Condiciones de Vida",
        yaxisname: "IMCV",
